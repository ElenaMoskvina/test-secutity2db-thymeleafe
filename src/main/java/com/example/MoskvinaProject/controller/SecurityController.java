...
import com.example.MoskvinaProject.service.UserService;
   ...
   public String login () {return "login";}
                                ...
                                Model model)
    {
        ...
        if (existingUser != null && existingUser.getEmail() != null && !existingUser.getEmail().isEmpty()) {
            result.rejectValue("email", null, "На этот адрес электронной почту уже зарегистрирована учетная запись.");
